...
class SvgWrapper {
  ...
  if (typeof target === 'string' || target instanceof String) {
    ...
    this.opts = options;
    this.uid = makeid(5); //test, see if changing the url you can have multiple render on the same page correctly
  ...
  constructSvg() {
    ...
    masks.setAttributeNS(null, 'id', this.uid+'__text-mask'); // create the css styles
    ...
    paths.setAttributeNS(null, 'mask', 'url(#'+this.uid+'__text-mask)');
  ...
  createGradient(line) {
    ...
    let gradient = document.createElementNS('http://www.w3.org/2000/svg', 'linearGradient'),
        gradientUrl = this.uid+'__'+`line-${this.gradientId++}`,
